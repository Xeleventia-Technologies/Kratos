...
public class Handler
{
    ...
    )
    {
        ...
        logger.LogInformation("Updating Feedback for user {UserId}", userId);
        ...
        {
            logger.LogError("Could not update feedback. Reason: {Error}", serviceResult.Error!.Message);
            return serviceResult.Error.AsHttpError();
        }

        logger.LogInformation("Feedback updated successfully.");
        return Results.Ok();
    }
}
